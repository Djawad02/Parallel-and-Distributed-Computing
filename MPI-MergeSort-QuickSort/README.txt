...
The Q1.c file contains a simple serial program of Quicksort and Mergesort which takes input as array size and reads the corresponding file to take input.If the file is missing a new file is created and updated with random values.
